...
| Treesitter Markdown parsers | `render-markdown.nvim`                                 | Provide Markdown, inline Markdown, HTML, and YAML parsing for in-editor Markdown rendering; `nvim-treesitter` uses its Neovim 0.12-compatible `main` branch. | `init.vim`                             |
